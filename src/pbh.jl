...
function Running(R::RGE, mt::Float64, xi::Float64)
    ...
    γ1 = -(9/4*R.g2^2 + 3/4*R.g1^2 - 3R.yt^2);

    # 2-loop Beta Function
    β2_lH = 1/48*((912+3sh)*R.g2^6 - (290-sh)*R.g1^2*R.g2^4 - (560-sh)*R.g1^4*R.g2^2 - (380-sh)*R.g1^6) + (38-8sh)*R.yt^6 - R.yt^4*(8/3*R.g1^2 + 32R.g3^2 + (12-117sh+108sh^2)*R.lH) + R.lH*(-1/8*(181 + 54sh - 162sh^2)*R.g2^4 + 1/4*(3 - 18sh + 54sh^2)*R.g1^2*R.g2^2 + 1/24*(90+377sh+162sh^2)*R.g1^4 + (27+54sh+27sh^2)*R.g2^2*R.lH + (9+18sh+9sh^2)*R.g1^2*R.lH - (48+288sh-324sh^2+624sh^3-324sh^4)*R.lH^2) + R.yt^2*(-9/4*R.g2^4 + 21/2*R.g1^2*R.g2^2 - 19/4*R.g1^4 + R.lH*(45/2*R.g2^2 + 85/6*R.g1^2 + 80R.g3^2 - (36+108sh^2)*R.lH));
    ...
    β2_yt = R.yt*(-23/4*R.g2^4 - 3/4*R.g1^2*R.g2^2 + 1187/216*R.g1^4 + 9R.g2^2*R.g3^2 + 19/9*R.g1^2*R.g3^2 - 108R.g3^4 + (225/16*R.g2^2 + 131/16*R.g1^2 + 36R.g3^2)*sh*R.yt^2 + 6*(-2sh^2*R.yt^4 - 2sh^3*R.yt^2*R.lH + sh^2*R.lH^2));
